...
Files: ./public/models/src/iconIG.glb [8.06MB] > C:\Users\Tommy\Documents\GitHub\frederic-cartier\models\512\models/512/iconIG-transformed.glb [66.89KB] (99%)
*/
...
export function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('/../../models/512/models/512/iconIG-transformed.glb') as GLTFResult
  return (
